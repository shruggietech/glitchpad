...
Glitchpad v0.1.2 is a community-supported binary release. Support covers reproducible defects in the published packages and documented stable capabilities; platform trust warnings caused by unsigned Windows or non-notarized macOS distribution are known constraints.
