...
For shared architecture and extension guidance, read [/docs/](/docs/). The hosted reference describes only the current generated kit. This bundled contract continues to govern these pinned delivered bytes.
