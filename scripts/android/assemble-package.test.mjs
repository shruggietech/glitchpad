...
test('assembly copies exact final bytes and emits canonical checksums and manifest', async () => {
      ...
      artifacts: [
        {
          role: 'universal',
          kind: 'apk',
          name: 'glitchpad-0.1.0-android-universal.apk',
        },
        {
          role: 'arm64',
          kind: 'apk',
          name: 'glitchpad-0.1.0-android-arm64.apk',
        },
        {
          role: 'play',
          kind: 'aab',
          name: 'glitchpad-0.1.0-android-universal.aab',
        },
      ],
  ...
  assert.match(
    ...
    /glitchpad-0\.1\.0-android-arm64\.apk/u,
  );
