...
export function validatePortableSmokeContract(lifecycleSource, workflowSource) {
  ...
  for (const requirement of ['[S030_ALPHA_RAW_SENTINEL]: https://example.invalid/alpha', '[S030_BETA_RAW_SENTINEL]: https://example.invalid/beta', '| Alpha | Beta |', 'Footnote[^1]', 'flowchart TB', 'Wait-SafeMarkdownOutcome', 'Wait-WindowText', 'Wait-NamedButton', 'TryGetCurrentPattern', 'LookupById(10018)', '$button.SetFocus()', 'System.Windows.Forms', "SendWait('{ENTER}')", 'Dismiss-Menu', "SendWait('{ESC}')", 'Send-MarkdownDelivery'])
