...
- **FR-019**: The compressed DMG MUST be measured as an actual artifact against the 35 MiB target and 60 MiB hard limit. Native cold startup MUST be recorded as hosted-smoke evidence with a 10-second candidate hard stop, and MUST satisfy the established desktop reference budget before official release evidence is accepted.
...
- **SC-007**: The DMG remains at or below the 35 MiB target and fails above 60 MiB. Candidate workflows retain truthful hosted-smoke startup classifications, while official release evidence remains blocked unless reference-profile cold startup stays within the existing desktop hard limit.
