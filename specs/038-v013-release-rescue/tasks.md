...
- [x] T036 Eliminate runner-version-sensitive PowerShell ordered-dictionary conversion for every Windows receipt value through a strict ordinal JSON-property path resolver and add a regression that rejects removing it
