...
- [x] T036 Correct PowerShell cast precedence for every Windows scale-receipt dictionary value and add a regression that rejects casting the dictionary before key lookup
