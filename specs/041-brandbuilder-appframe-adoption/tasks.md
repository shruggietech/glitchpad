...
- [x] T013 [US4] Commit, push, publish the downstream PR, address every CI/review finding, and request no more than one manual second Codex review round
- [x] T014 [US4] Replace the flaky hosted-emulator stock keyboard dependency with a test-only deterministic IME while preserving real WebView resize evidence
